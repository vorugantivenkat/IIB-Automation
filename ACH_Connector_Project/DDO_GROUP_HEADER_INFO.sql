...
CREATE TABLE "ACHADMIN"."DDO_GROUP_HEADER_INFO" (
...
CREATE UNIQUE INDEX "ACHADMIN"."DD_GRP_HEADER_INFO_PK"
	ON "ACHADMIN"."DDO_GROUP_HEADER_INFO"
	("DDO_GRP_HEADER_ID"		ASC)
	LOGGING;

ALTER TABLE "ACHADMIN"."DDO_GROUP_HEADER_INFO" ADD CONSTRAINT "DD_GRP_HEADER_INFO_PK" PRIMARY KEY
	("DDO_GRP_HEADER_ID");

	CREATE SEQUENCE  "ACHADMIN"."DDO_GROUP_HEADER_INFO_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 500 NOORDER  NOCYCLE ;
CREATE OR REPLACE TRIGGER "ACHADMIN"."DDO_GROUP_HEADER_INFO_TRG" 
	BEFORE INSERT ON "ACHADMIN"."DDO_GROUP_HEADER_INFO"
