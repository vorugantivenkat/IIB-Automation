...
CREATE TABLE "ACHADMIN"."PRI_TXN_INFO" (
...
ALTER TABLE "ACHADMIN"."PRI_TXN_INFO" ADD CONSTRAINT "SYS_C0011511" CHECK ("PR_TXN_INFO_ID" IS NOT NULL);

ALTER TABLE "ACHADMIN"."PRI_TXN_INFO" ADD CONSTRAINT "SYS_C0011512" PRIMARY KEY
	("PR_TXN_INFO_ID");
CREATE SEQUENCE  "ACHADMIN"."PRI_TXN_INFO_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 500 NOORDER  NOCYCLE ;
CREATE OR REPLACE TRIGGER "ACHADMIN"."PRI_TXN_INFO_TRIG" 
	BEFORE INSERT ON "ACHADMIN"."PRI_TXN_INFO"
