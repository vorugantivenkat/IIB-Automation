...
CREATE TABLE "ACHADMIN"."MANDATE_MGMT_INFO_INWARD" (
...
CREATE UNIQUE INDEX "ACHADMIN"."MANDATE_MGMT_INFO_INWARD_PK"
	ON "ACHADMIN"."MANDATE_MGMT_INFO_INWARD"
	("MND_GP_HDR_ID"		ASC)
	LOGGING;

ALTER TABLE "ACHADMIN"."MANDATE_MGMT_INFO_INWARD" ADD CONSTRAINT "MANDATE_MGMT_INFO_INWARD_PK" PRIMARY KEY
	("MND_GP_HDR_ID");

ALTER TABLE "ACHADMIN"."MANDATE_MGMT_INFO_INWARD" ADD CONSTRAINT "SYS_C0011515" CHECK ("MND_GP_HDR_ID" IS NOT NULL);
CREATE SEQUENCE  "ACHADMIN"."MANDATE_MGMT_INFO_INWARD_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 500 NOORDER  NOCYCLE ;
CREATE OR REPLACE TRIGGER "ACHADMIN"."MANDATE_MGMT_INFO_INWARD_TRG" 
	BEFORE INSERT ON "ACHADMIN"."MANDATE_MGMT_INFO_INWARD"
