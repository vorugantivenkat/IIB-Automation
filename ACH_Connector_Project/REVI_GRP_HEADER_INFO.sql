...
CREATE TABLE "ACHADMIN"."REVI_GRP_HEADER_INFO" (
...
ALTER TABLE "ACHADMIN"."REVI_GRP_HEADER_INFO" ADD CONSTRAINT "SYS_C0011517" CHECK ("REV_GRP_HEADER_ID" IS NOT NULL);

ALTER TABLE "ACHADMIN"."REVI_GRP_HEADER_INFO" ADD CONSTRAINT "SYS_C0011518" CHECK ("SETTLE_INFO_METHOD" IS NOT NULL);

ALTER TABLE "ACHADMIN"."REVI_GRP_HEADER_INFO" ADD CONSTRAINT "SYS_C0011519" CHECK ("SETTLE_INFO_CLR_SYS_PRTRY" IS NOT NULL);

ALTER TABLE "ACHADMIN"."REVI_GRP_HEADER_INFO" ADD CONSTRAINT "SYS_C0011520" PRIMARY KEY
	("REV_GRP_HEADER_ID");

	CREATE SEQUENCE  "ACHADMIN"."REVI_GRP_HEADER_INFO_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 500 NOORDER  NOCYCLE ;
CREATE TRIGGER "ACHADMIN"."REVI_GRP_HEADER_INFO_TRIG" 
	BEFORE INSERT ON "ACHADMIN"."REVI_GRP_HEADER_INFO"
