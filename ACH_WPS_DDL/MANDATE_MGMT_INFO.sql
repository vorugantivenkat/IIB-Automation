...
ALTER TABLE "ESBACH"."MANDATE_MGMT_INFO" ADD CONSTRAINT "SYS_C0011513" CHECK ("MND_GP_HDR_ID" IS NOT NULL);

ALTER TABLE "ESBACH"."MANDATE_MGMT_INFO" ADD CONSTRAINT "SYS_C0011514" PRIMARY KEY
	("MND_GP_HDR_ID");

CREATE TRIGGER "ESBACH"."MANDATE_MGMT_INFO_TRG" 
