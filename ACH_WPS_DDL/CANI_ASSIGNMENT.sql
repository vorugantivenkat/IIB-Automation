...
ALTER TABLE "ESBACH"."CANI_ASSIGNMENT" ADD CONSTRAINT "SYS_C0011388" PRIMARY KEY
	("CANC_ASSIGNMENT_ID");

ALTER TABLE "ESBACH"."CANI_ASSIGNMENT" ADD CONSTRAINT "SYS_C0011389" CHECK ("CANC_ASSIGNMENT_ID" IS NOT NULL);

CREATE TRIGGER "ESBACH"."CANI_ASSIGNMENT_TRIG" 
	BEFORE INSERT ON "ESBACH"."CANI_ASSIGNMENT"
