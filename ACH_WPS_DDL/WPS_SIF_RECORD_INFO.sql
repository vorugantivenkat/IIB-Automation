...
ALTER TABLE "ESBACH"."WPS_SIF_RECORD_INFO" ADD CONSTRAINT "SYS_C0011533" CHECK ("WPS_SIF_RECORD_INFO_ID" IS NOT NULL);

ALTER TABLE "ESBACH"."WPS_SIF_RECORD_INFO" ADD CONSTRAINT "SYS_C0011534" CHECK ("SIF_FILE_NAME" IS NOT NULL);

ALTER TABLE "ESBACH"."WPS_SIF_RECORD_INFO" ADD CONSTRAINT "SYS_C0011535" CHECK ("WPS_SIF_HEADER_INFO_ID" IS NOT NULL);

ALTER TABLE "ESBACH"."WPS_SIF_RECORD_INFO" ADD CONSTRAINT "SYS_C0011536" PRIMARY KEY
	("WPS_SIF_RECORD_INFO_ID");

ALTER TABLE "ESBACH"."WPS_SIF_RECORD_INFO" ADD CONSTRAINT "SYS_C0011537" FOREIGN KEY
	("WPS_SIF_HEADER_INFO_ID")
	REFERENCES "ESBACH"."WPS_SIF_HEADER_INFO"
	("WPS_SIF_HEADER_INFO_ID");

CREATE TRIGGER "ESBACH"."WPS_SIF_RECORD_INFO_TRIG" 
	BEFORE INSERT ON "ESBACH"."WPS_SIF_RECORD_INFO"
