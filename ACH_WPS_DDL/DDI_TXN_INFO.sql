...
ALTER TABLE "ESBACH"."DDI_TXN_INFO" ADD CONSTRAINT "SYS_C0011496" CHECK ("DDI_TXN_INFO_ID" IS NOT NULL);

ALTER TABLE "ESBACH"."DDI_TXN_INFO" ADD CONSTRAINT "SYS_C0011497" PRIMARY KEY
	("DDI_TXN_INFO_ID");

ALTER TABLE "ESBACH"."DDI_TXN_INFO" ADD CONSTRAINT "SYS_C0011498" FOREIGN KEY
	("DDI_GP_HDR_ID_TXN_FK")
	REFERENCES "ESBACH"."DDI_GP_HEADER_INFO"
	("DDI_GP_HEADER_ID")
	DISABLE;

CREATE TRIGGER "ESBACH"."DDI_TXN_INFO_TRIG" 
	BEFORE INSERT ON "ESBACH"."DDI_TXN_INFO"
